const profileData = {
  ...
  about: {
    ...
    contact: {
      email: "getdzidon@gmail.com",
      phone: "+420 777 841 469",
  ...
  links: [
    ...
    {
      title: "Github",
      src: "https://github.com/Getdzidon",
  ...
  skills: [
    ...
    {
      title: "Languages",
      value: "Bash, JavaScript, C++ & Python Scripting",
    },
    {
  ...
  experiences: [
    {
      ...
      title: "<strong>Senior Systems Engineer</strong>",
      date: "Oct 2022 to Current",
      details: [
    ...
    {
      organization: "Webhelp Enterprice",
      title: `<strong>Windows Administrator</strong>`,
      date: "Aug 2019 to Sep 2022",
      details: [
  ...
  education: [
    {
      alma: "CZECH UNIVERSITY OF LIFE SCIENCES",
      duration: "Oct 2017 to Sep 2019",
      std: "Master degree (Ing.)",
      score: "88.25%",
    },
    {
      alma: "K.N.U.S.T, GHANA",
